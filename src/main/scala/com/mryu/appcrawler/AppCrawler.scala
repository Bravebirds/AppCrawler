...
object AppCrawler extends CommonLog {
  val banner=
    s"""
      ...
      |项目地址: https://github.com/YuYanQing5920/AppCrawler
      |联络作者: mryu168@163.com
      |--------------------------------
      |
    """.stripMargin
  ...
  def createParser(): scopt.OptionParser[Param] ={
    val parser = new scopt.OptionParser[Param]("appcrawler") {
      ...
      help("help") text (
        """
          |示例
          |AppCrawler -a com.mryu.devstudy.apk
          |AppCrawler -a com.mryu.devstudy.apk --capability noReset=true
          |AppCrawler -c conf/com.mryu.devstudy -p android -o result/
          |AppCrawler -c com.mryu.devstudy --capability udid=[你的udid] -a Snowball.app
          |AppCrawler -c com.mryu.devstudy -a Snowball.app -u 4730
          |AppCrawler -c com.mryu.devstudy -a Snowball.app -u http://127.0.0.1:4730/wd/hub
          |
          |#生成demo例子
          |AppCrawler --demo
          |
          |#启动已经安装过的app
          |AppCrawler --capability "appPackage=com.com.mryu.devstudy.android,appActivity=.view.WelcomeActivityAlias"
          |
          |#从已经结束的结果中重新生成报告
